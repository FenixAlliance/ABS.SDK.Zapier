...
module.exports = {
    createAssetTransferAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/AssetsService/AssetTransfers'),
                    method: 'POST',
    ...
    deleteAssetTransferAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/AssetsService/AssetTransfers/{transferId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getAssetTransfersCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/AssetsService/AssetTransfers/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchAssetTransferAsync: {
        key: 'patchAssetTransferAsync',
        noun: 'AssetTransfers',
        display: {
            label: 'Partially updates an existing asset transfer',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetTransferAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
