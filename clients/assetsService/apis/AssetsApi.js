...
const AssetCategoryDtoCollectionQueryParameters = require('../models/AssetCategoryDtoCollectionQueryParameters');
...
const AssetDepreciationRecordDtoCollectionQueryParameters = require('../models/AssetDepreciationRecordDtoCollectionQueryParameters');
...
const AssetDtoCollectionQueryParameters = require('../models/AssetDtoCollectionQueryParameters');
...
const AssetRepairDtoCollectionQueryParameters = require('../models/AssetRepairDtoCollectionQueryParameters');
...
const AssetValueAmendDtoCollectionQueryParameters = require('../models/AssetValueAmendDtoCollectionQueryParameters');
...
module.exports = {
    ...
    getAssetAssetCategories: {
        ...
        operation: {
            inputFields: [
                ...
                ...AssetCategoryDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...AssetCategoryDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getAssetDepreciationRecords: {
        ...
        operation: {
            inputFields: [
                ...
                ...AssetDepreciationRecordDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...AssetDepreciationRecordDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getAssetRepairs: {
        ...
        operation: {
            inputFields: [
                ...
                ...AssetRepairDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...AssetRepairDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getAssetValueAmends: {
        ...
        operation: {
            inputFields: [
                ...
                ...AssetValueAmendDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...AssetValueAmendDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getAssets: {
        ...
        operation: {
            inputFields: [
                ...
                ...AssetDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...AssetDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    patchAsset: {
        ...
        noun: 'Assets',
        display: {
            label: 'Partially updates an existing asset',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAsset', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchAssetAssetCategory: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetAssetCategory', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchAssetDepreciationRecord: {
        key: 'patchAssetDepreciationRecord',
        noun: 'Assets',
        display: {
            label: 'Partially updates a depreciation record for an asset',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetDepreciationRecord', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchAssetRepair: {
        key: 'patchAssetRepair',
        noun: 'Assets',
        display: {
            label: 'Partially updates a repair for an asset',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetRepair', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchAssetTransfer: {
        key: 'patchAssetTransfer',
        noun: 'Assets',
        display: {
            label: 'Partially updates a transfer for an asset',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetTransfer', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchAssetValueAmend: {
        key: 'patchAssetValueAmend',
        noun: 'Assets',
        display: {
            label: 'Partially updates a value amendment for an asset',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchAssetValueAmend', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
