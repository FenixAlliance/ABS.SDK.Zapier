const samples = require('../samples/ProjectTasksApi');
const EmptyEnvelope = require('../models/EmptyEnvelope');
const ErrorEnvelope = require('../models/ErrorEnvelope');
const Int32Envelope = require('../models/Int32Envelope');
const Operation = require('../models/Operation');
const ProjectTaskCreateDto = require('../models/ProjectTaskCreateDto');
const ProjectTaskDtoEnvelope = require('../models/ProjectTaskDtoEnvelope');
...
module.exports = {
    createProjectTaskAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ProjectsService/ProjectTasks'),
                    method: 'POST',
    ...
    deleteProjectTaskAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ProjectsService/ProjectTasks/{projectTaskId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getProjectTaskByIdAsync: {
        key: 'getProjectTaskByIdAsync',
        noun: 'ProjectTasks',
        display: {
            label: 'Get project task by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...ProjectTaskDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ProjectsService/ProjectTasks/{projectTaskId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getProjectTaskByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['ProjectTaskDtoEnvelopeSample']
        }
    },
    ...
    getProjectTasksCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ProjectsService/ProjectTasks/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchProjectTaskAsync: {
        key: 'patchProjectTaskAsync',
        noun: 'ProjectTasks',
        display: {
            label: 'Patch a project task',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchProjectTaskAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
