...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}issuedDate`,
                label: `[${labelPrefix}issuedDate]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}onBoardDate`,
                label: `[${labelPrefix}onBoardDate]`,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'issuedDate': bundle.inputData?.[`${keyPrefix}issuedDate`],
            'onBoardDate': bundle.inputData?.[`${keyPrefix}onBoardDate`],
