...
module.exports = {
    createItemShippingPolicyAsync: {
        key: 'createItemShippingPolicyAsync',
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Create an item shipping policy',
        ...
        operation: {
            inputFields: [
                ...
                ...ItemShippingPolicyCreateDto.fields(),
            ],
            outputFields: [
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ShipmentsService/ItemShippingPolicies'),
                    method: 'POST',
                    ...
                    body: {
                        ...ItemShippingPolicyCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createItemShippingPolicyAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    deleteItemShippingPolicyAsync: {
        key: 'deleteItemShippingPolicyAsync',
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Delete an item shipping policy',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ShipmentsService/ItemShippingPolicies/{policyId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteItemShippingPolicyAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getItemShippingPoliciesAsync: {
        ...
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Get all item shipping policies',
    ...
    getItemShippingPoliciesCountAsync: {
        key: 'getItemShippingPoliciesCountAsync',
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Get item shipping policies count',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ShipmentsService/ItemShippingPolicies/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getItemShippingPoliciesCountAsync', response.json);
                    return results;
                })
            },
    ...
    patchItemShippingPolicyAsync: {
        key: 'patchItemShippingPolicyAsync',
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Patch an item shipping policy',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemShippingPolicyAsync', response.json);
                    return results;
                })
            },
    ...
    updateItemShippingPolicyAsync: {
        key: 'updateItemShippingPolicyAsync',
        noun: 'ItemShippingPolicies',
        display: {
            label: 'Update an item shipping policy',
        ...
        operation: {
            inputFields: [
                ...
                ...ItemShippingPolicyUpdateDto.fields(),
            ],
            outputFields: [
            ],
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ItemShippingPolicyUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateItemShippingPolicyAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
