...
const ProviderWebhookRegistrationCreatedDto = require('../models/ProviderWebhookRegistrationCreatedDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ProviderWebhookRegistrationCreatedDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ProviderWebhookRegistrationCreatedDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
