...
const SalesLiteratureTypeDto = require('../models/SalesLiteratureTypeDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...SalesLiteratureTypeDto.fields(`${keyPrefix}salesLiteratureType`, isInput),
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'salesLiteratureType': utils.removeIfEmpty(SalesLiteratureTypeDto.mapping(bundle, `${keyPrefix}salesLiteratureType`)),
