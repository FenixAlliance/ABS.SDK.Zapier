...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}dealUnitLines`,
                label: `[${labelPrefix}dealUnitLines]`,
                children: DealUnitLineCreateDto.fields(`${keyPrefix}dealUnitLines${!isInput ? '[]' : ''}`, isInput, true), 
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'dealUnitLines': utils.childMapping(bundle.inputData?.[`${keyPrefix}dealUnitLines`], `${keyPrefix}dealUnitLines`, DealUnitLineCreateDto),
        }
    },
}
