...
const SimpleTenantEnrollmentDto = require('../models/SimpleTenantEnrollmentDto');
const SimpleUserDto = require('../models/SimpleUserDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...SimpleUserDto.fields(`${keyPrefix}user`, isInput),
            ...TenantDto.fields(`${keyPrefix}receiverTenant`, isInput),
            ...SimpleContactDto.fields(`${keyPrefix}individual`, isInput),
            ...SimpleContactDto.fields(`${keyPrefix}organization`, isInput),
            ...SimpleTenantEnrollmentDto.fields(`${keyPrefix}enrollment`, isInput),
            {
                key: `${keyPrefix}invoiceLines`,
                label: `[${labelPrefix}invoiceLines]`,
                children: InvoiceLineDto.fields(`${keyPrefix}invoiceLines${!isInput ? '[]' : ''}`, isInput, true), 
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'user': utils.removeIfEmpty(SimpleUserDto.mapping(bundle, `${keyPrefix}user`)),
            'receiverTenant': utils.removeIfEmpty(TenantDto.mapping(bundle, `${keyPrefix}receiverTenant`)),
            'individual': utils.removeIfEmpty(SimpleContactDto.mapping(bundle, `${keyPrefix}individual`)),
            'organization': utils.removeIfEmpty(SimpleContactDto.mapping(bundle, `${keyPrefix}organization`)),
            'enrollment': utils.removeIfEmpty(SimpleTenantEnrollmentDto.mapping(bundle, `${keyPrefix}enrollment`)),
            'invoiceLines': utils.childMapping(bundle.inputData?.[`${keyPrefix}invoiceLines`], `${keyPrefix}invoiceLines`, InvoiceLineDto),
        }
    },
}
