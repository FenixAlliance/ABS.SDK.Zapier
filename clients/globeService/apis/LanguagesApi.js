...
const CountryLanguageDtoCollectionQueryParameters = require('../models/CountryLanguageDtoCollectionQueryParameters');
...
module.exports = {
    countLanguagesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...CountryLanguageDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/GlobeService/Languages/Count'),
                    method: 'GET',
                    ...
                    body: {
                        ...CountryLanguageDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
    ...
    getLanguageByIdAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/GlobeService/Languages/{languageId}'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getLanguagesAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/GlobeService/Languages'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
