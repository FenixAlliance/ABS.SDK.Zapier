...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}grantedPermissionsCount`,
                label: `[${labelPrefix}grantedPermissionsCount]`,
                type: 'integer',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'grantedPermissionsCount': bundle.inputData?.[`${keyPrefix}grantedPermissionsCount`],
        }
    },
}
