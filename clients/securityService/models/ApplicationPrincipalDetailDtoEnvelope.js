...
const ApplicationPrincipalDetailDto = require('../models/ApplicationPrincipalDetailDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ApplicationPrincipalDetailDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ApplicationPrincipalDetailDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
