...
const SecurityCertificateDtoCollectionQueryParameters = require('../models/SecurityCertificateDtoCollectionQueryParameters');
    ...
    getSecurityCertificatesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...SecurityCertificateDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...SecurityCertificateDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
