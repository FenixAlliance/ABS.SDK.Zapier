...
module.exports = {
    createBusinessApplicationAsync: {
        key: 'createBusinessApplicationAsync',
        noun: 'Applications',
        display: {
            label: 'Create a new business application',
        ...
        operation: {
            inputFields: [
                ...
                ...BusinessApplicationCreateDto.fields(),
                {
                    key: 'api-version',
                    label: '',
                    type: 'string',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...BusinessApplicationCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createBusinessApplicationAsync', response.json);
                    return results;
                })
            },
    ...
    deleteBusinessApplicationAsync: {
        key: 'deleteBusinessApplicationAsync',
        noun: 'Applications',
        display: {
            label: 'Delete a business application',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteBusinessApplicationAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    getBusinessApplicationByIdAsync: {
        key: 'getBusinessApplicationByIdAsync',
        noun: 'Applications',
        display: {
            label: 'Get business application by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...BusinessApplicationDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SecurityService/Applications/{applicationId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessApplicationByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['BusinessApplicationDtoEnvelopeSample']
        }
    },
    getBusinessApplicationsAsync: {
        key: 'getBusinessApplicationsAsync',
        noun: 'Applications',
        display: {
            label: 'Get all business applications',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessApplicationsAsync', response.json);
                    return results;
                })
            },
            sample: samples['BusinessApplicationDtoListEnvelopeSample']
        }
    },
    getBusinessApplicationsCountAsync: {
        key: 'getBusinessApplicationsCountAsync',
        noun: 'Applications',
        display: {
            label: 'Get business applications count',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessApplicationsCountAsync', response.json);
                    return results;
                })
            },
    ...
    getPermissionsByApplicationAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SecurityService/Applications/{applicationId}/Permissions'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getRolesByApplicationAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SecurityService/Applications/{applicationId}/Roles'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchBusinessApplicationAsync: {
        key: 'patchBusinessApplicationAsync',
        noun: 'Applications',
        display: {
            label: 'Patch an existing business application',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchBusinessApplicationAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    updateBusinessApplicationAsync: {
        key: 'updateBusinessApplicationAsync',
        noun: 'Applications',
        display: {
            label: 'Update an existing business application',
        ...
        operation: {
            inputFields: [
                ...
                ...BusinessApplicationUpdateDto.fields(),
                {
                    key: 'api-version',
                    label: '',
                    type: 'string',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...BusinessApplicationUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateBusinessApplicationAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
