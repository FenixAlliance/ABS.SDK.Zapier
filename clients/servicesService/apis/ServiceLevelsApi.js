const samples = require('../samples/ServiceLevelsApi');
...
module.exports = {
    countAllServiceLevelsAsync: {
        key: 'countAllServiceLevelsAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Get all service levels count',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'countAllServiceLevelsAsync', response.json);
                    return results;
                })
            },
    ...
    createServiceLevelAsync: {
        key: 'createServiceLevelAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Create a service level',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ServiceLevelCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createServiceLevelAsync', response.json);
                    return results;
                })
            },
    ...
    deleteServiceLevelAsync: {
        key: 'deleteServiceLevelAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Delete a service level',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteServiceLevelAsync', response.json);
                    return results;
                })
            },
            sample: samples['EnvelopeSample']
    ...
    getAllServiceLevelsAsync: {
        key: 'getAllServiceLevelsAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Get all service levels',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAllServiceLevelsAsync', response.json);
                    return results;
                })
            },
            sample: samples['ServiceLevelDtoIReadOnlyListEnvelopeSample']
        }
    },
    getServiceLevelByIdAsync: {
        key: 'getServiceLevelByIdAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Get a service level by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...ServiceLevelDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ServicesService/Services/{serviceId}/ServiceLevels/{serviceLevelId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getServiceLevelByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['ServiceLevelDtoEnvelopeSample']
        }
    },
    getServiceLevelsAsync: {
        key: 'getServiceLevelsAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Get all service levels',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getServiceLevelsAsync', response.json);
                    return results;
                })
            },
            sample: samples['ServiceLevelDtoIReadOnlyListEnvelopeSample']
    ...
    getServiceLevelsCountAsync: {
        key: 'getServiceLevelsCountAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Get service levels count',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getServiceLevelsCountAsync', response.json);
                    return results;
                })
            },
            sample: samples['Int32EnvelopeSample']
    ...
    patchServiceLevelAsync: {
        key: 'patchServiceLevelAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Patch a service level',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchServiceLevelAsync', response.json);
                    return results;
                })
            },
            sample: samples['EnvelopeSample']
    ...
    updateServiceLevelAsync: {
        key: 'updateServiceLevelAsync',
        noun: 'ServiceLevels',
        display: {
            label: 'Update a service level',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ServiceLevelUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateServiceLevelAsync', response.json);
                    return results;
                })
            },
            sample: samples['EnvelopeSample']
