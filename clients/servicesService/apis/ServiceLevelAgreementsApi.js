...
const ServiceLevelAgreementDtoCollectionQueryParameters = require('../models/ServiceLevelAgreementDtoCollectionQueryParameters');
...
module.exports = {
    createServiceLevelAgreementAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ServicesService/ServiceLevelAgreements'),
                    method: 'POST',
    ...
    deleteServiceLevelAgreementAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ServicesService/ServiceLevelAgreements/{serviceLevelAgreementId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getServiceLevelAgreementsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...ServiceLevelAgreementDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ServiceLevelAgreementDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getServiceLevelAgreementsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ServicesService/ServiceLevelAgreements/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchServiceLevelAgreementAsync: {
        key: 'patchServiceLevelAgreementAsync',
        noun: 'ServiceLevelAgreements',
        display: {
            label: 'Patch a service level agreement',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchServiceLevelAgreementAsync', response.json);
                    return results;
                })
            },
            sample: samples['EnvelopeSample']
