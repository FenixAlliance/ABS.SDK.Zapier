...
const ServiceLevelDto = require('../models/ServiceLevelDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ServiceLevelDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ServiceLevelDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
