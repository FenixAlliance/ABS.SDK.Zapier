...
const OpenIdConfiguration = require('../models/OpenIdConfiguration');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...OpenIdConfiguration.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(OpenIdConfiguration.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
