...
const JsonWebKeySet = require('../models/JsonWebKeySet');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...JsonWebKeySet.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(JsonWebKeySet.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
