...
const ItemPriceCalculation = require('../models/ItemPriceCalculation');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ItemPriceCalculation.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ItemPriceCalculation.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
