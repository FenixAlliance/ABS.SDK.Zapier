...
const ConversationAttachmentUploadResultDto = require('../models/ConversationAttachmentUploadResultDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ConversationAttachmentUploadResultDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ConversationAttachmentUploadResultDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
