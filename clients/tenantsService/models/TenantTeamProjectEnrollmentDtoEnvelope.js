...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TenantTeamProjectEnrollmentDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TenantTeamProjectEnrollmentDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
