...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TenantTeamContactEnrollmentDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TenantTeamContactEnrollmentDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
