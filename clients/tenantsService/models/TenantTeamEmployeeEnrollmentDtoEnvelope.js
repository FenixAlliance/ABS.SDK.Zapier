...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TenantTeamEmployeeEnrollmentDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TenantTeamEmployeeEnrollmentDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
