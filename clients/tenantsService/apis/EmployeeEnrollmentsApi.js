...
const TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters = require('../models/TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters');
...
module.exports = {
    createTenantEmployeeEnrollment: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/TenantsService/EmployeeEnrollments'),
                    method: 'POST',
    ...
    deleteTenantEmployeeEnrollment: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/TenantsService/EmployeeEnrollments/{tenantEmployeeEnrollmentId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getTenantEmployeeEnrollments: {
        ...
        operation: {
            inputFields: [
                ...
                ...TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getTenantEmployeeEnrollmentsCount: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/TenantsService/EmployeeEnrollments/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchTenantEmployeeEnrollmentAsync: {
        key: 'patchTenantEmployeeEnrollmentAsync',
        noun: 'EmployeeEnrollments',
        display: {
            label: 'Patch a tenant employee enrollment',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchTenantEmployeeEnrollmentAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
