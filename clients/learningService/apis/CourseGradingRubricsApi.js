...
const CourseGradingRubricDtoCollectionQueryParameters = require('../models/CourseGradingRubricDtoCollectionQueryParameters');
    ...
    getCourseGradingRubricsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...CourseGradingRubricDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ],
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...CourseGradingRubricDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
