...
const CourseAssignmentComponentDtoCollectionQueryParameters = require('../models/CourseAssignmentComponentDtoCollectionQueryParameters');
...
module.exports = {
    createCourseAssignmentComponentAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseAssignmentComponents'),
                    method: 'POST',
    ...
    deleteCourseAssignmentComponentAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseAssignmentComponents/{componentId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getCourseAssignmentComponentsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...CourseAssignmentComponentDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ],
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...CourseAssignmentComponentDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getCourseAssignmentComponentsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseAssignmentComponents/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchCourseAssignmentComponentAsync: {
        key: 'patchCourseAssignmentComponentAsync',
        noun: 'CourseAssignmentComponents',
        display: {
            label: 'Patch a course assignment component',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchCourseAssignmentComponentAsync', response.json);
                    return results;
                })
            },
