...
const CourseTeamMembershipDtoCollectionQueryParameters = require('../models/CourseTeamMembershipDtoCollectionQueryParameters');
...
module.exports = {
    createCourseTeamMembershipAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseTeamMemberships'),
                    method: 'POST',
    ...
    deleteCourseTeamMembershipAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseTeamMemberships/{membershipId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getCourseTeamMembershipsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...CourseTeamMembershipDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ],
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...CourseTeamMembershipDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getCourseTeamMembershipsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/LearningService/CourseTeamMemberships/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchCourseTeamMembershipAsync: {
        key: 'patchCourseTeamMembershipAsync',
        noun: 'CourseTeamMemberships',
        display: {
            label: 'Patch a course team membership',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchCourseTeamMembershipAsync', response.json);
                    return results;
                })
            },
