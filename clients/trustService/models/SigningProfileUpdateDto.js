...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}signaturePurpose`,
                label: `[${labelPrefix}signaturePurpose]`,
                type: 'string',
                choices: [
                    'Unknown',
            ...
            {
                key: `${keyPrefix}policyUri`,
                label: `[${labelPrefix}policyUri]`,
                type: 'string',
            },
            {
            ...
            {
                key: `${keyPrefix}defaultForDocumentType`,
                label: `[${labelPrefix}defaultForDocumentType]`,
                type: 'string',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'signaturePurpose': bundle.inputData?.[`${keyPrefix}signaturePurpose`],
            ...
            'policyUri': bundle.inputData?.[`${keyPrefix}policyUri`],
            'authorityProfile': bundle.inputData?.[`${keyPrefix}authorityProfile`],
            'isActive': bundle.inputData?.[`${keyPrefix}isActive`],
            'defaultForDocumentType': bundle.inputData?.[`${keyPrefix}defaultForDocumentType`],
        }
    },
}
