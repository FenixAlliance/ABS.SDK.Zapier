...
const TrustArtifactReferenceDto = require('../models/TrustArtifactReferenceDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TrustArtifactReferenceDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TrustArtifactReferenceDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
