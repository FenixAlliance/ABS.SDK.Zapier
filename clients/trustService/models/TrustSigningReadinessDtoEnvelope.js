...
const TrustSigningReadinessDto = require('../models/TrustSigningReadinessDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TrustSigningReadinessDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TrustSigningReadinessDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
