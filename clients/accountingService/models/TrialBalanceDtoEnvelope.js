...
const TrialBalanceDto = require('../models/TrialBalanceDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...TrialBalanceDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(TrialBalanceDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
