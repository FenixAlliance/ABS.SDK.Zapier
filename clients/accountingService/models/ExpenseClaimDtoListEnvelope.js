...
const ExpenseClaimDto = require('../models/ExpenseClaimDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                children: ExpenseClaimDto.fields(`${keyPrefix}result${!isInput ? '[]' : ''}`, isInput, true), 
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.childMapping(bundle.inputData?.[`${keyPrefix}result`], `${keyPrefix}result`, ExpenseClaimDto),
        }
    },
}
