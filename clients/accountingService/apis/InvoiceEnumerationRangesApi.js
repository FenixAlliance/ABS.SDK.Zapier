...
module.exports = {
    ...
    patchInvoiceEnumerationRangeAsync: {
        key: 'patchInvoiceEnumerationRangeAsync',
        noun: 'InvoiceEnumerationRanges',
        display: {
            label: 'Patch an invoice enumeration range',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchInvoiceEnumerationRangeAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
