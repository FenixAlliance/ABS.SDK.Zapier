...
const FiscalResponsibilityDtoCollectionQueryParameters = require('../models/FiscalResponsibilityDtoCollectionQueryParameters');
    ...
    getFiscalResponsibilities: {
        ...
        operation: {
            inputFields: [
                ...
                ...FiscalResponsibilityDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...FiscalResponsibilityDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
