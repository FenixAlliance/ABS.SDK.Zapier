...
const CurriculumDtoCollectionQueryParameters = require('../models/CurriculumDtoCollectionQueryParameters');
    ...
    getCurriculumsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...CurriculumDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...CurriculumDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
