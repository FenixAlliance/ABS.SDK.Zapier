const samples = require('../samples/SocialGroupsApi');
...
module.exports = {
    countSocialGroupsAsync: {
        key: 'countSocialGroupsAsync',
        noun: 'SocialGroups',
        display: {
            label: 'Count social groups',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'countSocialGroupsAsync', response.json);
                    return results;
                })
            },
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...SocialGroupCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createSocialGroupAsync', response.json);
                    return results;
                })
            },
    ...
    deleteSocialGroupAsync: {
        key: 'deleteSocialGroupAsync',
        noun: 'SocialGroups',
        display: {
            label: 'Delete a social group',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteSocialGroupAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    getSocialGroupByIdAsync: {
        key: 'getSocialGroupByIdAsync',
        noun: 'SocialGroups',
        display: {
            label: 'Get social group by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...SocialGroupDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/SocialService/SocialGroups/{socialGroupId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getSocialGroupByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['SocialGroupDtoEnvelopeSample']
        }
    },
    getSocialGroupsAsync: {
        key: 'getSocialGroupsAsync',
        noun: 'SocialGroups',
        display: {
            label: 'Get social groups',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getSocialGroupsAsync', response.json);
                    return results;
                })
            },
    ...
    updateSocialGroupAsync: {
        key: 'updateSocialGroupAsync',
        noun: 'SocialGroups',
        display: {
            label: 'Update a social group',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...SocialGroupUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateSocialGroupAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
