...
const SocialPostReactionDto = require('../models/SocialPostReactionDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...SocialPostReactionDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(SocialPostReactionDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
