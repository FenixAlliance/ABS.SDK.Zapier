...
module.exports = {
    countWebTemplatesAsync: {
        key: 'countWebTemplatesAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Count web templates',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'countWebTemplatesAsync', response.json);
                    return results;
                })
            },
    ...
    createWebTemplateAsync: {
        key: 'createWebTemplateAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Create a web template',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...WebTemplateCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createWebTemplateAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    deleteWebTemplateAsync: {
        key: 'deleteWebTemplateAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Delete a web template',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteWebTemplateAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getWebTemplateByIdAsync: {
        key: 'getWebTemplateByIdAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Get web template by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...WebTemplateDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ContentService/WebTemplates/{webTemplateId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getWebTemplateByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['WebTemplateDtoEnvelopeSample']
        }
    },
    getWebTemplatesAsync: {
        key: 'getWebTemplatesAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Get web templates',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getWebTemplatesAsync', response.json);
                    return results;
                })
            },
    ...
    updateWebTemplateAsync: {
        key: 'updateWebTemplateAsync',
        noun: 'WebTemplates',
        display: {
            label: 'Update a web template',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...WebTemplateUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateWebTemplateAsync', response.json);
                    return results;
                })
            },
            sample: { data: {} }
