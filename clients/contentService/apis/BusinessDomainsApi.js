...
const BusinessDomainCreateDto = require('../models/BusinessDomainCreateDto');
const BusinessDomainDtoCollectionQueryParameters = require('../models/BusinessDomainDtoCollectionQueryParameters');
...
const BusinessDomainUpdateDto = require('../models/BusinessDomainUpdateDto');
...
module.exports = {
    createBusinessDomainAsync: {
        key: 'createBusinessDomainAsync',
        noun: 'BusinessDomains',
        display: {
            label: 'Register a business domain',
        ...
        operation: {
            inputFields: [
                ...
                ...BusinessDomainCreateDto.fields(),
                {
                    key: 'api-version',
                    label: '',
                    type: 'string',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...BusinessDomainCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createBusinessDomainAsync', response.json);
                    return results;
                })
            },
    ...
    deleteBusinessDomainAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteBusinessDomainAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    getBusinessDomainByIdAsync: {
        key: 'getBusinessDomainByIdAsync',
        noun: 'BusinessDomains',
        display: {
            label: 'Get business domain by ID',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessDomainByIdAsync', response.json);
                    return results;
                })
            },
    ...
    getBusinessDomainsAsync: {
        key: 'getBusinessDomainsAsync',
        noun: 'BusinessDomains',
        display: {
            label: 'Get business domains',
        ...
        operation: {
            inputFields: [
                ...
                ...BusinessDomainDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...BusinessDomainDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessDomainsAsync', response.json);
                    return results;
                })
            },
    ...
    getBusinessDomainsCountAsync: {
        key: 'getBusinessDomainsCountAsync',
        noun: 'BusinessDomains',
        display: {
            label: 'Get business domains count',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getBusinessDomainsCountAsync', response.json);
                    return results;
                })
            },
    ...
    updateBusinessDomainAsync: {
        key: 'updateBusinessDomainAsync',
        noun: 'BusinessDomains',
        display: {
            label: 'Update a business domain',
        ...
        operation: {
            inputFields: [
                ...
                ...BusinessDomainUpdateDto.fields(),
                {
                    key: 'api-version',
                    label: '',
                    type: 'string',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...BusinessDomainUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateBusinessDomainAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    verifyBusinessDomainAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'verifyBusinessDomainAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
