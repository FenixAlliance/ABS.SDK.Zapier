const samples = require('../samples/MenuContextsApi');
...
module.exports = {
    countMenuContextsAsync: {
        key: 'countMenuContextsAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Count menu contexts',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'countMenuContextsAsync', response.json);
                    return results;
                })
            },
    ...
    createMenuContextAsync: {
        key: 'createMenuContextAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Create a menu context',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...MenuContextCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createMenuContextAsync', response.json);
                    return results;
                })
            },
    ...
    deleteMenuContextAsync: {
        key: 'deleteMenuContextAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Delete a menu context',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteMenuContextAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    getMenuContextByIdAsync: {
        key: 'getMenuContextByIdAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Get menu context by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...MenuContextDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/ContentService/MenuContexts/{menuContextId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getMenuContextByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['MenuContextDtoEnvelopeSample']
        }
    },
    getMenuContextsAsync: {
        key: 'getMenuContextsAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Get menu contexts',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getMenuContextsAsync', response.json);
                    return results;
                })
            },
            sample: samples['MenuContextDtoListEnvelopeSample']
        }
    },
    updateMenuContextAsync: {
        key: 'updateMenuContextAsync',
        noun: 'MenuContexts',
        display: {
            label: 'Update a menu context',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...MenuContextUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateMenuContextAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
