...
const WebsiteThemeDtoETag = require('../models/WebsiteThemeDtoETag');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...WebsiteThemeDtoETag.fields(`${keyPrefix}ifMatch`, isInput),
            ...WebsiteThemeDtoETag.fields(`${keyPrefix}ifNoneMatch`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'ifMatch': utils.removeIfEmpty(WebsiteThemeDtoETag.mapping(bundle, `${keyPrefix}ifMatch`)),
            'ifNoneMatch': utils.removeIfEmpty(WebsiteThemeDtoETag.mapping(bundle, `${keyPrefix}ifNoneMatch`)),
        }
    },
}
