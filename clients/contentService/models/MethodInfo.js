...
const ParameterInfo = require('../models/ParameterInfo');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ParameterInfo.fields(`${keyPrefix}returnParameter`, isInput),
            ...Type.fields(`${keyPrefix}returnType`, isInput),
            {
                key: `${keyPrefix}returnTypeCustomAttributes`,
                label: `[${labelPrefix}returnTypeCustomAttributes]`,
                dict: true,
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'returnParameter': utils.removeIfEmpty(ParameterInfo.mapping(bundle, `${keyPrefix}returnParameter`)),
            'returnType': utils.removeIfEmpty(Type.mapping(bundle, `${keyPrefix}returnType`)),
            'returnTypeCustomAttributes': bundle.inputData?.[`${keyPrefix}returnTypeCustomAttributes`],
        }
    },
}
