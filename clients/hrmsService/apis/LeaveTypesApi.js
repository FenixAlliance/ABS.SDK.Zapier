const samples = require('../samples/LeaveTypesApi');
...
module.exports = {
    createLeaveTypeAsync: {
        key: 'createLeaveTypeAsync',
        noun: 'LeaveTypes',
        display: {
            label: 'Create a leave type',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...LeaveTypeCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createLeaveTypeAsync', response.json);
                    return results;
                })
            },
    ...
    deleteLeaveTypeAsync: {
        key: 'deleteLeaveTypeAsync',
        noun: 'LeaveTypes',
        display: {
            label: 'Delete a leave type',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'deleteLeaveTypeAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    getLeaveTypeByIdAsync: {
        key: 'getLeaveTypeByIdAsync',
        noun: 'LeaveTypes',
        display: {
            label: 'Get leave type by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...LeaveTypeDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/HrmsService/LeaveTypes/{leaveTypeId}'),
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getLeaveTypeByIdAsync', response.json);
                    return results;
                })
            },
            sample: samples['LeaveTypeDtoEnvelopeSample']
        }
    },
    getLeaveTypesAsync: {
        key: 'getLeaveTypesAsync',
        noun: 'LeaveTypes',
        display: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getLeaveTypesAsync', response.json);
                    return results;
                })
            },
            sample: samples['LeaveTypeDtoListEnvelopeSample']
        }
    },
    getLeaveTypesCountAsync: {
        key: 'getLeaveTypesCountAsync',
        noun: 'LeaveTypes',
        display: {
            label: 'Count leave types',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getLeaveTypesCountAsync', response.json);
                    return results;
                })
            },
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...LeaveTypeUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateLeaveTypeAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
