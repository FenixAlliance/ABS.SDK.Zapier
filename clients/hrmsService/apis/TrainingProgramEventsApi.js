...
const TrainingProgramEventDtoCollectionQueryParameters = require('../models/TrainingProgramEventDtoCollectionQueryParameters');
...
module.exports = {
    createTrainingProgramEventAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/HrmsService/TrainingProgramEvents'),
                    method: 'POST',
    ...
    deleteTrainingProgramEventAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/HrmsService/TrainingProgramEvents/{eventId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getTrainingProgramEventsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...TrainingProgramEventDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...TrainingProgramEventDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getTrainingProgramEventsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/HrmsService/TrainingProgramEvents/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchTrainingProgramEventAsync: {
        key: 'patchTrainingProgramEventAsync',
        noun: 'TrainingProgramEvents',
        display: {
            label: 'Patch a training program event',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchTrainingProgramEventAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
