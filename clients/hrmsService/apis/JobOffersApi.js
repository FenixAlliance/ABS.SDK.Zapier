const samples = require('../samples/JobOffersApi');
const EmptyEnvelope = require('../models/EmptyEnvelope');
const ErrorEnvelope = require('../models/ErrorEnvelope');
const Int32Envelope = require('../models/Int32Envelope');
const JobOfferCreateDto = require('../models/JobOfferCreateDto');
const JobOfferDtoCollectionQueryParameters = require('../models/JobOfferDtoCollectionQueryParameters');
const JobOfferDtoEnvelope = require('../models/JobOfferDtoEnvelope');
const JobOfferDtoListEnvelope = require('../models/JobOfferDtoListEnvelope');
const JobOfferUpdateDto = require('../models/JobOfferUpdateDto');
...
module.exports = {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...JobOfferCreateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'createJobOfferAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    deleteJobOfferAsync: {
        key: 'deleteJobOfferAsync',
        noun: 'JobOffers',
        display: {
            label: 'Delete a job offer',
    ...
    getJobOfferByIdAsync: {
        key: 'getJobOfferByIdAsync',
        noun: 'JobOffers',
        display: {
            label: 'Get job offer by ID',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getJobOfferByIdAsync', response.json);
                    return results;
                })
            },
    ...
    getJobOffersAsync: {
        key: 'getJobOffersAsync',
        noun: 'JobOffers',
        display: {
            label: 'Get job offers',
        ...
        operation: {
            inputFields: [
                ...
                ...JobOfferDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...JobOfferDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getJobOffersAsync', response.json);
                    return results;
                })
            },
    ...
    getJobOffersCountAsync: {
        key: 'getJobOffersCountAsync',
        noun: 'JobOffers',
        display: {
            label: 'Count job offers',
    ...
    patchJobOfferAsync: {
        key: 'patchJobOfferAsync',
        noun: 'JobOffers',
        display: {
            label: 'Patch a job offer',
    ...
    updateJobOfferAsync: {
        key: 'updateJobOfferAsync',
        noun: 'JobOffers',
        display: {
            label: 'Update a job offer',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...JobOfferUpdateDto.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'updateJobOfferAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
