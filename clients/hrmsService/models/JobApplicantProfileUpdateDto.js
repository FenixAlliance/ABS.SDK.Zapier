...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}availableForHire`,
                label: `[${labelPrefix}availableForHire]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}careerLevel`,
                label: `[${labelPrefix}careerLevel]`,
                type: 'string',
                choices: [
                    'Junior',
                    'Intermediate',
            ...
            {
                key: `${keyPrefix}currentSalary`,
                label: `[${labelPrefix}currentSalary]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}minSalaryExpectation`,
                label: `[${labelPrefix}minSalaryExpectation]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}maxSalaryExpectation`,
                label: `[${labelPrefix}maxSalaryExpectation]`,
                type: 'number',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'availableForHire': bundle.inputData?.[`${keyPrefix}availableForHire`],
            'careerLevel': bundle.inputData?.[`${keyPrefix}careerLevel`],
            'experienceInYears': bundle.inputData?.[`${keyPrefix}experienceInYears`],
            'currentSalary': bundle.inputData?.[`${keyPrefix}currentSalary`],
            'minSalaryExpectation': bundle.inputData?.[`${keyPrefix}minSalaryExpectation`],
            'maxSalaryExpectation': bundle.inputData?.[`${keyPrefix}maxSalaryExpectation`],
