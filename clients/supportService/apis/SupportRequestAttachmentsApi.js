...
module.exports = {
    createSupportRequestAttachmentAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/SupportService/SupportRequestAttachments'),
                    method: 'POST',
    ...
    deleteSupportRequestAttachmentAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/SupportService/SupportRequestAttachments/{supportRequestAttachmentId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getSupportRequestAttachmentsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/SupportService/SupportRequestAttachments/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchSupportRequestAttachmentAsync: {
        key: 'patchSupportRequestAttachmentAsync',
        noun: 'SupportRequestAttachments',
        display: {
            label: 'Patch a support request attachment',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchSupportRequestAttachmentAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
