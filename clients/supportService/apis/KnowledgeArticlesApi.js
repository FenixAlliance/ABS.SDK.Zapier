...
const KnowledgeArticleDtoCollectionQueryParameters = require('../models/KnowledgeArticleDtoCollectionQueryParameters');
...
module.exports = {
    createKnowledgeArticleAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SupportService/KnowledgeArticles'),
                    method: 'POST',
    ...
    deleteKnowledgeArticleAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SupportService/KnowledgeArticles/{knowledgeArticleId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getKnowledgeArticlesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...KnowledgeArticleDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...KnowledgeArticleDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getKnowledgeArticlesCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/SupportService/KnowledgeArticles/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchKnowledgeArticleAsync: {
        key: 'patchKnowledgeArticleAsync',
        noun: 'KnowledgeArticles',
        display: {
            label: 'Patch a knowledge article',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchKnowledgeArticleAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
