...
module.exports = {
    ...
    patchSupportTicketPriorityAsync: {
        key: 'patchSupportTicketPriorityAsync',
        noun: 'SupportTicketPriorities',
        display: {
            label: 'Patch a support ticket priority',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchSupportTicketPriorityAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
