...
const FileUploadDto = require('../models/FileUploadDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...FileUploadDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(FileUploadDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
