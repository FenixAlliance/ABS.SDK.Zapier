...
const BlockchainDtoETag = require('../models/BlockchainDtoETag');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...BlockchainDtoETag.fields(`${keyPrefix}ifMatch`, isInput),
            ...BlockchainDtoETag.fields(`${keyPrefix}ifNoneMatch`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'ifMatch': utils.removeIfEmpty(BlockchainDtoETag.mapping(bundle, `${keyPrefix}ifMatch`)),
            'ifNoneMatch': utils.removeIfEmpty(BlockchainDtoETag.mapping(bundle, `${keyPrefix}ifNoneMatch`)),
        }
    },
}
