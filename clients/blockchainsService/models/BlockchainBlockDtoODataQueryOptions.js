...
const BlockchainBlockDtoETag = require('../models/BlockchainBlockDtoETag');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...BlockchainBlockDtoETag.fields(`${keyPrefix}ifMatch`, isInput),
            ...BlockchainBlockDtoETag.fields(`${keyPrefix}ifNoneMatch`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'ifMatch': utils.removeIfEmpty(BlockchainBlockDtoETag.mapping(bundle, `${keyPrefix}ifMatch`)),
            'ifNoneMatch': utils.removeIfEmpty(BlockchainBlockDtoETag.mapping(bundle, `${keyPrefix}ifNoneMatch`)),
        }
    },
}
