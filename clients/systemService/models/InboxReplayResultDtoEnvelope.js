...
const InboxReplayResultDto = require('../models/InboxReplayResultDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...InboxReplayResultDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(InboxReplayResultDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
