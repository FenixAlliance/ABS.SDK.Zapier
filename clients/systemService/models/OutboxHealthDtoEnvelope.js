...
const OutboxHealthDto = require('../models/OutboxHealthDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...OutboxHealthDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(OutboxHealthDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
