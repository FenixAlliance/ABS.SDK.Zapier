...
const UserAdminDetailDto = require('../models/UserAdminDetailDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...UserAdminDetailDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(UserAdminDetailDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
