...
const SystemOverviewDto = require('../models/SystemOverviewDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...SystemOverviewDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(SystemOverviewDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
