...
const GuestCartPurgeResultDto = require('../models/GuestCartPurgeResultDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...GuestCartPurgeResultDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(GuestCartPurgeResultDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
