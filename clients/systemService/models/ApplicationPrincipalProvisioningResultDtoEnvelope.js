...
const ApplicationPrincipalProvisioningResultDto = require('../models/ApplicationPrincipalProvisioningResultDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...ApplicationPrincipalProvisioningResultDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(ApplicationPrincipalProvisioningResultDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
