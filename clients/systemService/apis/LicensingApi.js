const samples = require('../samples/LicensingApi');
const BooleanEnvelope = require('../models/BooleanEnvelope');
const ErrorEnvelope = require('../models/ErrorEnvelope');
const IValidationFailureListEnvelope = require('../models/IValidationFailureListEnvelope');
const LicenseValidationRequest = require('../models/LicenseValidationRequest');
const SuiteLicenseAssignmentDtoListEnvelope = require('../models/SuiteLicenseAssignmentDtoListEnvelope');
const SuiteLicenseDtoEnvelope = require('../models/SuiteLicenseDtoEnvelope');
const SuiteLicenseDtoListEnvelope = require('../models/SuiteLicenseDtoListEnvelope');
const utils = require('../utils/utils');

module.exports = {
    getAttributesForLicenseAsync: {
        key: 'getAttributesForLicenseAsync',
        noun: 'Licensing',
        display: {
            label: 'Retrieve license attributes',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAttributesForLicenseAsync', response.json);
                    return results;
                })
            },
    ...
    getFeaturesForLicenseAsync: {
        key: 'getFeaturesForLicenseAsync',
        noun: 'Licensing',
        display: {
            label: 'Retrieve license features',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getFeaturesForLicenseAsync', response.json);
                    return results;
                })
            },
            sample: samples['SuiteLicenseAssignmentDtoListEnvelopeSample']
    ...
    getLicenseAssignmentsAsync: {
        key: 'getLicenseAssignmentsAsync',
        noun: 'Licensing',
        display: {
            label: 'Retrieve license assignments',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getLicenseAssignmentsAsync', response.json);
                    return results;
                })
            },
            sample: samples['SuiteLicenseAssignmentDtoListEnvelopeSample']
    ...
    getLicenseByIdAsync: {
        ...
        noun: 'Licensing',
        display: {
            label: 'Retrieve a license by ID',
        ...
        operation: {
            ...
            outputFields: [
                ...SuiteLicenseDtoEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
            ...
            sample: samples['SuiteLicenseDtoEnvelopeSample']
        }
    },
    getLicenseRecordsQuotaAsync: {
        key: 'getLicenseRecordsQuotaAsync',
        noun: 'Licensing',
        display: {
            label: 'Retrieve license record quota',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getLicenseRecordsQuotaAsync', response.json);
                    return results;
                })
            },
            sample: samples['SuiteLicenseAssignmentDtoListEnvelopeSample']
    ...
    getLicensesAsync: {
        ...
        noun: 'Licensing',
        display: {
            label: 'Retrieve a list of licenses',
    ...
    redeemLicenseAsync: {
        key: 'redeemLicenseAsync',
        noun: 'Licensing',
        display: {
            label: 'Redeem a license',
        ...
        operation: {
            inputFields: [
                ...
                ...LicenseValidationRequest.fields(),
                {
                    key: 'api-version',
                    label: '',
                    type: 'string',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...LicenseValidationRequest.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'redeemLicenseAsync', response.json);
                    return results;
                })
            },
    ...
    validateLicenseAsync: {
        key: 'validateLicenseAsync',
        noun: 'Licensing',
        display: {
            label: 'Validate a license',
        ...
        operation: {
            ...
            outputFields: [
                ...IValidationFailureListEnvelope.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'validateLicenseAsync', response.json);
                    return results;
                })
            },
            sample: samples['IValidationFailureListEnvelopeSample']
        }
    },
}
