const samples = require('../samples/FenixAlliancePortalsWebsiteApi');
...
module.exports = {
    accountLogoutPost: {
        ...
        noun: 'FenixAlliance.Portals.Website',
        display: {
            label: '',
            description: '',
            hidden: false,
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                const options = {
                    url: utils.replacePathParameters('http://localhost/Account/Logout'),
                    method: 'POST',
    ...
    accountManageDownloadPersonalDataPost: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/Account/Manage/DownloadPersonalData'),
                    method: 'POST',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    accountManageLinkExternalLoginPost: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                const options = {
                    url: utils.replacePathParameters('http://localhost/Account/Manage/LinkExternalLogin'),
                    method: 'POST',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
    ...
    accountPerformExternalLoginPost: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                formData.append('returnUrl', bundle.inputData?.['returnUrl'])
                const options = {
                    url: utils.replacePathParameters('http://localhost/Account/PerformExternalLogin'),
                    method: 'POST',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
