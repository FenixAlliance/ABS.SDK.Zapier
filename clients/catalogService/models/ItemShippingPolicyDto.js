...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}isExpressShipmentPolicy`,
                label: `[${labelPrefix}isExpressShipmentPolicy]`,
                type: 'boolean',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'isExpressShipmentPolicy': bundle.inputData?.[`${keyPrefix}isExpressShipmentPolicy`],
