...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}productsCount`,
                label: `[${labelPrefix}productsCount]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}merchantRating`,
                label: `[${labelPrefix}merchantRating]`,
                type: 'number',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'productsCount': bundle.inputData?.[`${keyPrefix}productsCount`],
            'merchantRating': bundle.inputData?.[`${keyPrefix}merchantRating`],
        }
    },
}
