...
const ItemAttributeOptionDtoCollectionQueryParameters = require('../models/ItemAttributeOptionDtoCollectionQueryParameters');
...
module.exports = {
    createItemAttributeOptionAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/CatalogService/ItemAttributeOptions'),
                    method: 'POST',
    ...
    deleteItemAttributeOptionAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/CatalogService/ItemAttributeOptions/{itemAttributeOptionId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getItemAttributeOptionsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...ItemAttributeOptionDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ItemAttributeOptionDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getItemAttributeOptionsCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://absuite.net/api/v2/CatalogService/ItemAttributeOptions/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': 'application/json, application/xml',
    ...
    patchItemAttributeOptionAsync: {
        key: 'patchItemAttributeOptionAsync',
        noun: 'ItemAttributeOptions',
        display: {
            label: 'Patch an item attribute option',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemAttributeOptionAsync', response.json);
                    return results;
                })
            },
