...
const LicenseAttributeDtoCollectionQueryParameters = require('../models/LicenseAttributeDtoCollectionQueryParameters');
    ...
    getLicenseAttributesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...LicenseAttributeDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...LicenseAttributeDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
