...
const MarketingCampaignDto = require('../models/MarketingCampaignDto');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...MarketingCampaignDto.fields(`${keyPrefix}result`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'result': utils.removeIfEmpty(MarketingCampaignDto.mapping(bundle, `${keyPrefix}result`)),
        }
    },
}
