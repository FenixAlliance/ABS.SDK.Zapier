...
module.exports = {
    apiV2AiServiceCompletionsCompleteGet: {
        key: 'apiV2AiServiceCompletionsCompleteGet',
        noun: 'Completions',
        display: {
            label: '',
            description: '',
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    params: {
                        ...
                        'conversationId': bundle.inputData?.['conversationId'],
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'apiV2AiServiceCompletionsCompleteGet', response.json);
                    return results;
                })
            },
            sample: { data: {} }
