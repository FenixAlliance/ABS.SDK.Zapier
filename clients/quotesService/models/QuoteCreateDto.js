...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}quoteLines`,
                label: `[${labelPrefix}quoteLines]`,
                children: QuoteLineCreateDto.fields(`${keyPrefix}quoteLines${!isInput ? '[]' : ''}`, isInput, true), 
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'quoteLines': utils.childMapping(bundle.inputData?.[`${keyPrefix}quoteLines`], `${keyPrefix}quoteLines`, QuoteLineCreateDto),
        }
    },
}
