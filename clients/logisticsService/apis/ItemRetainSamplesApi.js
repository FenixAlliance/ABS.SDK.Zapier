const samples = require('../samples/ItemRetainSamplesApi');
...
module.exports = {
    createItemRetainSampleAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/LogisticsService/ItemRetainSamples'),
                    method: 'POST',
    ...
    deleteItemRetainSampleAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/LogisticsService/ItemRetainSamples/{retainSampleId}'),
                    method: 'DELETE',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    getItemRetainSamplesCountAsync: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('http://localhost/api/v2/LogisticsService/ItemRetainSamples/Count'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchItemRetainSampleAsync: {
        key: 'patchItemRetainSampleAsync',
        noun: 'ItemRetainSamples',
        display: {
            label: 'Patch an item retain sample',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemRetainSampleAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
