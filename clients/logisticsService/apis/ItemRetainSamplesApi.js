...
const ItemRetainSampleDtoCollectionQueryParameters = require('../models/ItemRetainSampleDtoCollectionQueryParameters');
    ...
    getItemRetainSamplesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...ItemRetainSampleDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ItemRetainSampleDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
