...
const WarehouseDtoCollectionQueryParameters = require('../models/WarehouseDtoCollectionQueryParameters');
...
module.exports = {
    ...
    getWarehousesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...WarehouseDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...WarehouseDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    patchWarehouseAsync: {
        key: 'patchWarehouseAsync',
        noun: 'Warehouses',
        display: {
            label: 'Patch a warehouse',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchWarehouseAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
