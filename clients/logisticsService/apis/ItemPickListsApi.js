...
module.exports = {
    ...
    patchItemPickListAsync: {
        key: 'patchItemPickListAsync',
        noun: 'ItemPickLists',
        display: {
            label: 'Patch an item pick list',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemPickListAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchItemPickListEntryAsync: {
        key: 'patchItemPickListEntryAsync',
        noun: 'ItemPickLists',
        display: {
            label: 'Patch a pick list entry',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemPickListEntryAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
