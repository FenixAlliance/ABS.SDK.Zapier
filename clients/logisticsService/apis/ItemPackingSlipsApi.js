const samples = require('../samples/ItemPackingSlipsApi');
const EmptyEnvelope = require('../models/EmptyEnvelope');
const ErrorEnvelope = require('../models/ErrorEnvelope');
const Int32Envelope = require('../models/Int32Envelope');
const ItemPackingSlipCreateDto = require('../models/ItemPackingSlipCreateDto');
const ItemPackingSlipDtoCollectionQueryParameters = require('../models/ItemPackingSlipDtoCollectionQueryParameters');
...
const ItemPackingSlipEntryDtoCollectionQueryParameters = require('../models/ItemPackingSlipEntryDtoCollectionQueryParameters');
...
module.exports = {
    ...
    getItemPackingSlipEntriesAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...ItemPackingSlipEntryDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ItemPackingSlipEntryDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    getItemPackingSlipsAsync: {
        ...
        operation: {
            inputFields: [
                ...
                ...ItemPackingSlipDtoCollectionQueryParameters.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...ItemPackingSlipDtoCollectionQueryParameters.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    patchItemPackingSlipAsync: {
        key: 'patchItemPackingSlipAsync',
        noun: 'ItemPackingSlips',
        display: {
            label: 'Patch an item packing slip',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemPackingSlipAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
    ...
    patchItemPackingSlipEntryAsync: {
        key: 'patchItemPackingSlipEntryAsync',
        noun: 'ItemPackingSlips',
        display: {
            label: 'Patch a packing slip entry',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchItemPackingSlipEntryAsync', response.json);
                    return results;
                })
            },
            sample: samples['EmptyEnvelopeSample']
